...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setFixedSize(850, 500)  # Adjusted window size

        self.setStyleSheet("""
            QPushButton {
                background-color: darkgray;  /* Changed dark-grey to darkgray */
                color: white;
        ...
        labelmov.setGeometry(QRect(0, 0, 900, 478))  # Adjusted dimensions
        ...
        poke_label.setGeometry(QRect(50, 50, 900, 250))  # Adjusted geometry
        ...
        self.labelpic.setGeometry(QRect(400, 20, 550, 700))  # Adjusted dimensions
    ...
    def open_search_window(self, checked):
        if not checked:  # Changed is None to not checked
            self.w = SearchWindow()
        self.w.show()
